...
public class FornecimentoController {
	...
	public static void main(String[] args) {
		...
		ProdutoL1 p1 = new ProdutoL1(1L, "Arroz", 100, 18.90, f1);
		ProdutoL1 p2 = new ProdutoL1(2L, "Feijão", 100, 8.90, f1);
		ProdutoL1 p3 = new ProdutoL1(3L, "Batata", 100, 2.90, f2);
